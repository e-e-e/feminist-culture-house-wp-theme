...
<div id="leftcol" role="navigation" aria-label="main navigation">
...
<div id="rightcol" role="main" aria-label="page content">
	...
	<h1><?php the_field('bios_header'); ?></h1>

<?php
// check if the repeater field has rows of data
if( have_rows('bios-rows') ):
?>

<?php 	// loop through the rows of data
    while ( have_rows('bios-rows') ) : the_row(); ?>

	<div class="biorow">
	<div class="bioleftcol">
		<img class="biopic" src="<?php the_sub_field('bio_picture'); ?>">
	</div><!--bio leftcol-->
	...
	<br style="clear: both;">
		...
		<div id="pagefooter" role="footer" aria-label="footer">
			...
			<div id="footercol3">
				...
				<!-- update link when donate page is set up
				<a href="http://feministculturehouse.org/donate/"> //-->
					
				<?xml version="1.0" encoding="utf-8"?>
<!-- Generator: Adobe Illustrator 16.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg id="DONATE" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 106.121 99.485" enable-background="new 0 0 106.121 99.485"
	 xml:space="preserve">
