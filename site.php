...
<div id="header">
	<div id="fchheaderleft">
		<a href="http://www.feministculturehouse.org"><div id="fchlogotype">Feminist<br />Culture<br />House</div></a>
	</div>
	<div id="fchheaderright" role="banner">
		<a href="http://www.feministculturehouse.org"><img src="http://www.feministculturehouse.org/FCH-banner.png" alt="FCH banner"></a>
	</div>
	<div id="fchheaderrightmobile" role="banner">
		<a href="http://www.feministculturehouse.org"><img src="http://www.feministculturehouse.org/FCH.png" alt="FCH banner"></a>
	</div>
</div><!-- END header -->
...
<input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL2" aria-label="Enter your email address here">
<input type="submit" value="&#10004;" name="Join" id="mc-embedded-subscribe2" class="button" aria-label="Click to join our mailing list">
</div>
    ...
    <input aria-label="formvalue" type="text" name="b_ab3af42f3c21ed02a7a8e4321_4ac5facd20" tabindex="-1" value=""></div>
    </div>
</form>
</div>
...
<!-- Pagefooter Beginning // -->
			...
			<div id="footercol1">
                ...
                <br /> <br />
                <a href="https://www.facebook.com/Feminist-Culture-House-516421435429266/" target="_blank"><img src="http://feministculturehouse.org/wp-content/uploads/2020/05/facebook-logo.png" alt="facebook icon" style="width: 25px"></a>
                &nbsp;
                &nbsp;
                <a href="https://www.instagram.com/feministculturehouse/?igshid=2hizn9xhwql8&fbclid=IwAR3njLmQfmgxC92bEe237umwgFvcHi4IlEpGyUgOzPAt2RdlMlOKzCOANm8" target="_blank"><img src="http://feministculturehouse.org/wp-content/uploads/2020/05/instagram-icon-white.png" alt="instagram icon" style="width: 25px"></a>
                &nbsp;
                &nbsp;
                <img src="http://feministculturehouse.org/wp-content/uploads/2020/05/kone-logo-white.png" alt="Kone Foundation Logo White" style="width: 120px">
                <!-- LISA END -->

                
			</div>
			<div id="footercol2">
				<a href="http://www.feministculturehouse.org"><img src="http://www.feministculturehouse.org/FCH-footer.png" alt="FCH footer"></a>
			</div>
			<div id="footercol3">
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="106.121px" height="99.485px" viewBox="0 0 106.121 99.485" enable-background="new 0 0 106.121 99.485"
	 xml:space="preserve">
...
<glyph unicode="t" horiz-adv-x="423" d="M40,408l-30,70l82,0l0,108l123,-28l0,-80l122,0l30,-70l-152,0l0,-127C215,274 215,263 215,248C215,230 215,212 215,194C214,176 215,159 218,143C220,127 223,112 226,99C229,86 235,75 243,67C251,59 261,54 272,51C283,48 298,50 316,57C333,63 353,73 376,88l27,-31C364,22 332,-3 306,-17C286,-28 259,-26 224,-11C189,4 158,25 132,52C105,79 92,102 92,122l0,286z"/>
	...
	<g>
			...
			<text transform="matrix(0.9878 -0.1556 0.1556 0.9878 10.1914 61.6299)" fill="#FFFFFF" font-family="'YatraOne-Regular'" font-size="22.8378">Donate!</text>
	</g>
</g>
</svg>
